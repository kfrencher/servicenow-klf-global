...
You can start the Scheduled Import from the Scheduled Import record directly, but you can also manage it from the KLF_RecordImporter_State record from the 
...
1. The KLF_RecordImporter_State `Name` field (`u_name`) is set.
